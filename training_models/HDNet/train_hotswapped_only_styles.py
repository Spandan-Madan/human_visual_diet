...
from core.dataset_hotswapped_only_styles import COCODataset
...
dataloader = DataLoader(dataset, batch_size=cfg.batch_size, num_workers=1, shuffle=True, pin_memory=True, drop_last=True)
