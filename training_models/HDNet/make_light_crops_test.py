...
annot_file = '../openrooms/annotation_files/train_main_xml_50_lights_test_v3.json'
...
new_data_folder = '../DomainBed/domainbed/data/DGLights/'
...
for data in tqdm(dataloader):
    ...
    for i in range(len(impath_1)):
        ...
        new_save_folder = "%s/main_xml_50_lights_test/%s"%(new_data_folder, cat_names[label[i].item()])
