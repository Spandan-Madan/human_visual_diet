...
from core.dataset_hotswapped_augmented import COCODataset
...
parser.add_argument("--test_outname", default="test", type=str)
...
#         labels_cpu = torch.hstack((info_1[3], info_2[3]))
    ...
    if cfg.test_annotations is not None and cfg.test_imagedir is not None and epoch % args.test_frequency == 0:
        ...
        test_accuracy = test(model, cfg, cfg.test_annotations, cfg.test_imagedir, outdir=args.outdir, epoch=epoch, outname=args.test_outname)
