...
from test_mengmi_control import test
...
#         labels_cpu = torch.hstack((info_1[3], info_2[3]))
        ...
        output_uncertainty_branch , output_main_branch, output_weighted, uncertainty = model(target_images_all, target_images_all, bbox_all)
