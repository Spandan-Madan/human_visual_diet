...
if args.num_materials is not None and args.material_names is not None:
    ...
    sys.exit()
# if args.no_target and args.no_context:
...
model = TwoStreamVIT(NUM_CLASSES)
...
#         labels_cpu = torch.hstack((info_1[3], info_2[3]))
        ...
        # output_uncertainty_branch , output_main_branch, output_weighted, uncertainty = model(context_images_all, target_images_all)
