...
elif [ "$experiment_index" = "74" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped.py --annotations ../openrooms/annotation_files/train_main_viewpoints_0_1_v3.json --imagedir ../ --outdir v3_output/4_light_hotswapped_generalization_to_viewpoint/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_viewpoints_5_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_50_lights_1, main_xml_50_lights_2, main_xml_50_lights_3, main_xml_50_lights_4, mainDiffLight_xml1"
elif [ "$experiment_index" = "75" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped_mengmi_control.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir v3_output/4_styles_hotswapped_mengmi_control/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_xml_50_test_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "76" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped_mengmi_control.py --annotations ../openrooms/annotation_files/train_main_xml_50_lights_v3.json --imagedir ../ --outdir v3_output/4_lights_hotswapped_mengmi_control/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_xml_50_lights_test_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_50_lights_1, main_xml_50_lights_2, main_xml_50_lights_3, main_xml_50_lights_4"
elif [ "$experiment_index" = "77" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped_viewpoint_mengmi_control.py --annotations ../openrooms/annotation_files/train_main_viewpoints_0_1_v3.json --imagedir ../ --outdir v3_output/viewpoint_hotswapped_3_mengmi_control/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_viewpoints_5_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_viewpoint_2, main_xml_viewpoint_3, main_xml_viewpoint_4"
elif [ "$experiment_index" = "78" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir v3_output/4_styles_hotswapped_no_contrastive_loss/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_xml_50_test_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5" --hard_mining none
elif [ "$experiment_index" = "79" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped.py --annotations ../openrooms/annotation_files/train_main_xml_50_lights_v3.json --imagedir ../ --outdir v3_output/4_lights_hotswapped_no_contrastive_loss/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_xml_50_lights_test_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_50_lights_1, main_xml_50_lights_2, main_xml_50_lights_3, main_xml_50_lights_4" --hard_mining none
elif [ "$experiment_index" = "80" ]; then
    cd /n/holylfs05/LABS/pfister_lab/Lab/coxfs01/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    module load GCC/8.2.0-2.31.1
    conda activate domain_adaptation
    python train_hotswapped_viewpoint.py --annotations ../openrooms/annotation_files/train_main_viewpoints_0_1_v3.json --imagedir ../ --outdir v3_output/viewpoint_hotswapped_3_no_contrastive_loss/ --epochs 50 --batch_size 40 --test_annotations ../openrooms/annotation_files/train_main_viewpoints_5_v3.json --test_imagedir ../ --test_frequency 5 --pretrained --material_names "main_xml_viewpoint_2, main_xml_viewpoint_3, main_xml_viewpoint_4" --hard_mining none
fi
