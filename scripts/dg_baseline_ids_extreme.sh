...
python -m domainbed.scripts.train --data_dir=./domainbed/data/ --algorithm ERM --dataset DGMaterials --test_env 2 3 4 5 --output_dir train_output_extreme/ERM_test --batch_size 300
