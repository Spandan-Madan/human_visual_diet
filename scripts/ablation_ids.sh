...
if [ "$experiment_index" = "0" ]; then
    ...
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_only_non_flap_vit/ --non_contrastive --no_context --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "19" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/context_only_non_flap_vit/ --non_contrastive --no_target --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "20" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_context_non_flap_vit/ --non_contrastive --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "21" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_contrastive_non_flap_vit/ --no_context --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "22" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/context_contrastive_non_flap_vit/ --no_target --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "23" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_vit.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_context_contrastive_non_flap_vit/ --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "24" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_only_non_flap_cnn/ --non_contrastive --no_context --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "25" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/context_only_non_flap_cnn/ --non_contrastive --no_target --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "26" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_context_non_flap_cnn/ --non_contrastive --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "27" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_contrastive_non_flap_cnn/ --no_context --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "28" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/context_contrastive_non_flap_cnn/ --no_target --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
elif [ "$experiment_index" = "29" ]; then
    cd /n/pfister_lab2/Lab/spandan/contextual_domain_adaptation/WhenPigsFlyContext
    eval "$(conda shell.bash hook)"
    conda activate domain_adaptation
    python train_hotswapped_non_flap_cnn.py --annotations ../openrooms/annotation_files/train_main_xml_50_v3.json --imagedir ../ --outdir ablation_experiments/target_context_contrastive_non_flap_cnn/ --epochs 50 --batch_size 5 --material_names "main_xml_50_2, main_xml_50_3, main_xml_50_4, main_xml_50_5"
fi
